...
import com.pharmaresolve.medcom.config.Constants;
import com.pharmaresolve.medcom.domain.User;
import com.pharmaresolve.medcom.repository.AuthorityRepository;
import com.pharmaresolve.medcom.repository.UserRepository;
import com.pharmaresolve.medcom.security.AuthoritiesConstants;
import com.pharmaresolve.medcom.service.UserService;
import com.pharmaresolve.medcom.service.dto.AdminUserDTO;
import com.pharmaresolve.medcom.service.dto.PasswordChangeDTO;
import com.pharmaresolve.medcom.web.rest.vm.KeyAndPasswordVM;
import com.pharmaresolve.medcom.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.PHARMACY_USER));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.PHARMACY_USER));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.PHARMACY_USER));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.orElseThrow().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.PHARMACY_USER).orElseThrow());
