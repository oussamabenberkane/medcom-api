...
- For the commit messages dont add long description and dont specify that it was generated by claude code, Example:
Good commit: feat(entities): 
add User-Pharmacy relationship and mailjetMessageId fields
Bad commit: feat(entities): 
add User-Pharmacy relationship and mailjetMessageId fields
- technical detail 1
- technical detail 2
🤖 This commit is generated by Claude Code
- Commit Message Format:
<type>(<scope>): <short description>
Where:

Type: Conventional commit types (feat, fix, chore, docs, style, refactor, test, etc.)
Scope: Context-specific area of the codebase (alert, pharmacy, watchlist, auth, api, etc.)
Description: Brief, clear summary of the change

Examples:

feat(pharmacy): add prescription refill reminders
fix(watchlist): resolve duplicate item display issue
chore(alert): update notification dependencies
docs(auth): add authentication endpoint